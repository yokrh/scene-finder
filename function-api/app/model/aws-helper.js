...
const accessKeyId = 'AKIARS7BSK62VVNYXYNR';  // new IAM one. Need to move in prod
const secretAccessKey = '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';  // new IAM one. Need to move in prod
